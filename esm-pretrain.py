...
#model = EsmForMaskedLM.from_config(config).to(device)
...
#config = AutoConfig.from_pretrained(
   # "facebook/esm2_t30_150M_UR50D",  # Using GPT-2 as a base for causal LM
...
# Then, create the model from the configuration
